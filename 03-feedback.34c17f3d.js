...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a="feedback-form-state",r=document.querySelector("input[type=email]"),n=document.querySelector("textarea[name=message]"),o=document.querySelector(".feedback-form"),l={email:"",message:""};function u(){l.email=r.value,localStorage.setItem(a,JSON.stringify(l))}function s(){l.message=n.value,localStorage.setItem(a,JSON.stringify(l))}function c(e){e.preventDefault(),console.log(l),e.currentTarget.reset(),localStorage.removeItem(a)}function i(){const e=localStorage.getItem(a);e&&(r.value=JSON.parse(e).email,n.value=JSON.parse(e).message)}i(),r.addEventListener("input",(0,e.default)(u,500)),n.addEventListener("input",(0,e.default)(s,500)),o.addEventListener("submit",c);
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.34c17f3d.js.map